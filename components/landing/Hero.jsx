...
function Hero() {
  return (
    <div className="grid sm:grid-cols-2 gap-4 px-4 py-12 items-center bg-black text-white bg-gradient-to-b from-black to-gray-900">
      <div>
      ...
      <div>
        <Image src="/lady.jpg" className="w-full rounded-md" width={500} height={500} alt="hero" />
      </div>
    </div>
  );
}
